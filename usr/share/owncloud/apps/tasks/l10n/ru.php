...
"Add an item due today in \"%s\"..." => "Добавить элемент к сегодняшней дате в \"%s\"...",
"Add an item in \"%s\"..." => "Добавить элемент в \"%s\"...",
"Add a current item in \"%s\"..." => "Добавить текущий элемент в \"%s\"...",
"_%n Completed Task_::_%n Completed Tasks_" => array("%n Завершенное Задание","%n Завершенных Заданий","%n Завершенных Заданий"),
