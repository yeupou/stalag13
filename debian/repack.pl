...
my %packages = (utils => ["/etc/bash_completion.d", "/etc/bashrc.d", "/etc/profile.d"],
		...
		"utils-exim" => ["/etc/exim4", "/usr/local/bin/memcached-exim.pl", "/usr/local/bin/memcached-exim"],
		...
		"utils-torrent" => ["/usr/local/bin/torrent-watch", "/usr/local/bin/torrent-watch.pl", "/usr/local/bin/torrent-watch", "/etc/cron.d/torrent", "/etc/logrotate.d/torrent"],
		"utils-tumblr" => ["/usr/local/bin/post-image-to-tumblr-init-auth.pl","/usr/local/bin/post-image-to-tumblr-init-auth", "/usr/local/bin/post-image-to-tumblr", "/usr/local/bin/post-image-to-tumblr.pl", "/usr/local/lib/site_perl/WWW/Tumblr.pm", "/usr/local/lib/site_perl/WWW/Tumblr"]
    );
